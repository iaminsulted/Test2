...
namespace System.Windows
{
	...
	{
		// Token: 0x06002916 RID: 10518 RVA: 0x00198448 File Offset: 0x00197448
		...
		// Token: 0x06002917 RID: 10519 RVA: 0x001985AC File Offset: 0x001975AC
		...
		// Token: 0x06002918 RID: 10520 RVA: 0x001985D7 File Offset: 0x001975D7
		...
		// Token: 0x06002919 RID: 10521 RVA: 0x001985EB File Offset: 0x001975EB
		...
		// Token: 0x0600291A RID: 10522 RVA: 0x00198610 File Offset: 0x00197610
		internal static FrugalObjectList<DependencyProperty> InvalidateTreeDependentProperties(TreeChangeInfo info, FrameworkElement fe, FrameworkContentElement fce, Style selfStyle, Style selfThemeStyle, ref ChildRecord childRecord, bool isChildRecordValid, bool hasStyleChanged, bool isSelfInheritanceParent, bool wasSelfInheritanceParent)
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				if (metadata.IsInherited)
				{
					...
					if (TreeWalkHelper.InvalidateTreeDependentProperty(info, dependencyObject, ref frameworkObject, dependencyProperty, frameworkPropertyMetadata, selfStyle, selfThemeStyle, ref childRecord, isChildRecordValid, hasStyleChanged, isSelfInheritanceParent, wasSelfInheritanceParent) && frugalObjectList2 != null && (!TreeWalkHelper.SkipNow(frameworkObject.InheritanceBehavior) || frameworkPropertyMetadata.OverridesInheritanceBehavior))
					{
		...
		// Token: 0x0600291B RID: 10523 RVA: 0x001986DC File Offset: 0x001976DC
		...
		// Token: 0x0600291C RID: 10524 RVA: 0x00198858 File Offset: 0x00197858
		internal static void InvalidateOnResourcesChange(FrameworkElement fe, FrameworkContentElement fce, ResourcesChangeInfo info)
		{
			...
			if (TreeWalkHelper.HasChildren(fe, fce))
			{
				new DescendentsWalker<ResourcesChangeInfo>(TreeWalkPriority.LogicalTree, TreeWalkHelper.ResourcesChangeDelegate, info).StartWalk(dependencyObject);
				return;
			}
			TreeWalkHelper.OnResourcesChanged(dependencyObject, info, true);
		}

		// Token: 0x0600291D RID: 10525 RVA: 0x001988B0 File Offset: 0x001978B0
		...
		// Token: 0x0600291E RID: 10526 RVA: 0x001988BC File Offset: 0x001978BC
		...
		// Token: 0x0600291F RID: 10527 RVA: 0x00198A98 File Offset: 0x00197A98
		...
		// Token: 0x06002920 RID: 10528 RVA: 0x00198B28 File Offset: 0x00197B28
		...
		// Token: 0x06002921 RID: 10529 RVA: 0x00198D64 File Offset: 0x00197D64
		internal static void InvalidateOnInheritablePropertyChange(FrameworkElement fe, FrameworkContentElement fce, InheritablePropertyChangeInfo info, bool skipStartNode)
		{
			...
			if (TreeWalkHelper.HasChildren(fe, fce))
			{
				...
				new DescendentsWalker<InheritablePropertyChangeInfo>(TreeWalkPriority.LogicalTree, TreeWalkHelper.InheritablePropertyChangeDelegate, info).StartWalk(@do, skipStartNode);
				return;
			}
			if (!skipStartNode)
			{
		...
		// Token: 0x06002922 RID: 10530 RVA: 0x00198DBC File Offset: 0x00197DBC
		...
		// Token: 0x06002923 RID: 10531 RVA: 0x00198F14 File Offset: 0x00197F14
		...
		// Token: 0x06002924 RID: 10532 RVA: 0x00198F44 File Offset: 0x00197F44
		...
		// Token: 0x06002925 RID: 10533 RVA: 0x00198FA4 File Offset: 0x00197FA4
		...
		// Token: 0x06002926 RID: 10534 RVA: 0x00198FEC File Offset: 0x00197FEC
		...
		// Token: 0x06002927 RID: 10535 RVA: 0x00199031 File Offset: 0x00198031
		...
		// Token: 0x06002928 RID: 10536 RVA: 0x00199042 File Offset: 0x00198042
		...
		// Token: 0x06002929 RID: 10537 RVA: 0x00199053 File Offset: 0x00198053
		...
		// Token: 0x0600292A RID: 10538 RVA: 0x00199082 File Offset: 0x00198082
