...
namespace System.Windows.Documents
{
	...
	{
		// Token: 0x06004A79 RID: 19065 RVA: 0x00233768 File Offset: 0x00232768
		internal static TextRange Find(ITextPointer start, ITextPointer end, string findPattern, CultureInfo cultureInfo, bool matchCase, bool matchWholeWord, bool matchLast, bool matchDiacritics, bool matchKashida, bool matchAlefHamza)
		{
			...
			{
				string text2 = FixedFindEngine._GetPageString((dynamicDocumentPaginator2 != null) ? (dynamicDocumentPaginator2.Source as FixedDocument) : (documentPaginatorSource as FixedDocument), num2, replaceAlefWithAlefHamza);
		...
		// Token: 0x06004A7A RID: 19066 RVA: 0x00233A74 File Offset: 0x00232A74
		...
		// Token: 0x06004A7B RID: 19067 RVA: 0x00233AC4 File Offset: 0x00232AC4
		...
		// Token: 0x06004A7C RID: 19068 RVA: 0x00233B0C File Offset: 0x00232B0C
		...
		// Token: 0x06004A7D RID: 19069 RVA: 0x00233BEC File Offset: 0x00232BEC
		private static string _GetPageString(FixedDocument doc, int translatedPageNo, bool replaceAlefWithAlefHamza)
		{
			string text = null;
			Stream pageStream = doc.Pages[translatedPageNo].GetPageStream();
		...
		// Token: 0x06004A7E RID: 19070 RVA: 0x00233C30 File Offset: 0x00232C30
		private static string _ConstructPageString(Stream pageStream, bool reverseRTL)
		{
			XmlReader xmlReader = new XmlCompatibilityReader(new XmlTextReader(pageStream), FixedFindEngine._predefinedNamespaces);
			...
			{
				if (xmlReader.NodeType == XmlNodeType.Element && xmlReader.Name == "Glyphs")
				{
		...
		// Token: 0x06004A7F RID: 19071 RVA: 0x000F7BD9 File Offset: 0x000F6BD9
