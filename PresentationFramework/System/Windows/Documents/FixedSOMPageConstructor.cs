...
namespace System.Windows.Documents
{
	...
	{
		// Token: 0x06004B7B RID: 19323 RVA: 0x0023725C File Offset: 0x0023625C
		...
		// Token: 0x06004B7C RID: 19324 RVA: 0x002372BC File Offset: 0x002362BC
		public FixedSOMPage ConstructPageStructure(List<FixedNode> fixedNodes)
		{
			...
			{
				(fixedSOMSemanticBox as FixedSOMContainer).SemanticBoxes.Sort();
			}
			this._DetectTables();
			this._CombinePass();
		...
		// Token: 0x06004B7D RID: 19325 RVA: 0x002373D0 File Offset: 0x002363D0
		...
		// (get) Token: 0x06004B7E RID: 19326 RVA: 0x00237495 File Offset: 0x00236495
		...
		// Token: 0x06004B7F RID: 19327 RVA: 0x002374A0 File Offset: 0x002364A0
		...
		// Token: 0x06004B80 RID: 19328 RVA: 0x00237508 File Offset: 0x00236508
		...
		// Token: 0x06004B81 RID: 19329 RVA: 0x0023776C File Offset: 0x0023676C
		...
		// Token: 0x06004B82 RID: 19330 RVA: 0x002377CC File Offset: 0x002367CC
		...
		// Token: 0x06004B83 RID: 19331 RVA: 0x002378BC File Offset: 0x002368BC
		...
		// Token: 0x06004B84 RID: 19332 RVA: 0x00237CEE File Offset: 0x00236CEE
		...
		// Token: 0x06004B85 RID: 19333 RVA: 0x00237D05 File Offset: 0x00236D05
		...
		// Token: 0x06004B86 RID: 19334 RVA: 0x00237D2C File Offset: 0x00236D2C
		...
		// Token: 0x06004B87 RID: 19335 RVA: 0x00237F98 File Offset: 0x00236F98
		...
		// Token: 0x06004B88 RID: 19336 RVA: 0x00237FF4 File Offset: 0x00236FF4
		...
		// Token: 0x06004B89 RID: 19337 RVA: 0x00238160 File Offset: 0x00237160
		...
		// Token: 0x06004B8A RID: 19338 RVA: 0x00238250 File Offset: 0x00237250
		...
		// Token: 0x06004B8B RID: 19339 RVA: 0x002382CC File Offset: 0x002372CC
		private void _ProcessOutlinePath(Matrix transform, PathGeometry pathGeom)
		{
			foreach (PathFigure pathFigure in pathGeom.Figures)
			{
				...
				foreach (PathSegment pathSegment in segments)
				{
					...
					else
					{
						...
						{
							using (PointCollection.Enumerator enumerator3 = (pathSegment as PolyLineSegment).Points.GetEnumerator())
							{
						...
						{
							PointCollection points2 = (pathSegment as PolyQuadraticBezierSegment).Points;
		...
		// Token: 0x06004B8C RID: 19340 RVA: 0x002384C8 File Offset: 0x002374C8
			...
			foreach (FixedSOMTable fixedSOMTable3 in list)
			{
				if (!fixedSOMTable3.IsSingleCelled)
				{
					...
					if (flag)
					{
						...
						{
							foreach (FixedSOMSemanticBox fixedSOMSemanticBox2 in ((FixedSOMTableRow)fixedSOMSemanticBox).SemanticBoxes)
							{
		...
		// Token: 0x06004B8D RID: 19341 RVA: 0x002388DC File Offset: 0x002378DC
