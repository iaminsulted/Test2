...
namespace System.Windows.Documents
{
	...
	{
		// Token: 0x06005251 RID: 21073 RVA: 0x002530C4 File Offset: 0x002520C4
		...
		// Token: 0x06005252 RID: 21074 RVA: 0x002530EA File Offset: 0x002520EA
		...
		// Token: 0x06005253 RID: 21075 RVA: 0x00253124 File Offset: 0x00252124
		...
		// (get) Token: 0x06005254 RID: 21076 RVA: 0x002532AC File Offset: 0x002522AC
		...
		// (get) Token: 0x06005255 RID: 21077 RVA: 0x002532B9 File Offset: 0x002522B9
		// (set) Token: 0x06005256 RID: 21078 RVA: 0x002532C1 File Offset: 0x002522C1
		...
		// (get) Token: 0x06005257 RID: 21079 RVA: 0x002532CA File Offset: 0x002522CA
		...
		// (set) Token: 0x06005258 RID: 21080 RVA: 0x002532D2 File Offset: 0x002522D2
		...
		// Token: 0x06005259 RID: 21081 RVA: 0x002532DC File Offset: 0x002522DC
		...
		// Token: 0x0600525A RID: 21082 RVA: 0x00253330 File Offset: 0x00252330
		internal void AppendDocument()
		{
			...
			if ((this.ForceParagraph || this.TreeContainsBlock()) && documentNodeArray.Count > 0 && documentNodeArray.EntryAt(documentNodeArray.Count - 1).IsInline)
			{
			...
			for (int i = 0; i < documentNodeArray.Count; i++)
			{
				...
				this._outerXamlBuilder.Append(documentNode2.Xaml);
			}
			if (flag)
			{
		...
		// Token: 0x0600525B RID: 21083 RVA: 0x0025346C File Offset: 0x0025246C
		internal void ProcessField()
		{
			...
			if (documentNode8 != null)
			{
				...
				else if (documentNode8.Type == DocumentNodeType.dnHyperlink)
				{
					...
					if (num6 > 0)
					{
						this.WrapInlineInParagraph(num7 + 1, num6);
						...
						if (documentNode12.Type == DocumentNodeType.dnParagraph && !documentNode12.IsTerminated)
						{
							...
							stringBuilder2.Append(documentNode12.Xaml);
							stringBuilder2.Append("</Hyperlink>");
							documentNode12.Xaml = stringBuilder2.ToString();
						}
					}
				}
			}
			...
			if (flag2)
			{
				...
				{
					DocumentNode documentNode13 = documentNodeArray.EntryAt(k);
		...
		// Token: 0x0600525C RID: 21084 RVA: 0x00253965 File Offset: 0x00252965
		...
		// Token: 0x0600525D RID: 21085 RVA: 0x0025399B File Offset: 0x0025299B
		...
		// Token: 0x0600525E RID: 21086 RVA: 0x002539B0 File Offset: 0x002529B0
		...
		// Token: 0x0600525F RID: 21087 RVA: 0x00253A08 File Offset: 0x00252A08
		...
		// Token: 0x06005260 RID: 21088 RVA: 0x00253BC4 File Offset: 0x00252BC4
		...
		// Token: 0x06005261 RID: 21089 RVA: 0x00253D44 File Offset: 0x00252D44
		...
		// Token: 0x06005262 RID: 21090 RVA: 0x00253EF8 File Offset: 0x00252EF8
		...
		// Token: 0x06005263 RID: 21091 RVA: 0x0025424C File Offset: 0x0025324C
		...
		// Token: 0x06005264 RID: 21092 RVA: 0x002542FC File Offset: 0x002532FC
		...
		// Token: 0x06005265 RID: 21093 RVA: 0x002543A8 File Offset: 0x002533A8
		...
		// Token: 0x06005266 RID: 21094 RVA: 0x002543EC File Offset: 0x002533EC
		...
		// Token: 0x06005267 RID: 21095 RVA: 0x00254558 File Offset: 0x00253558
		...
		// Token: 0x06005268 RID: 21096 RVA: 0x00254674 File Offset: 0x00253674
		...
		// Token: 0x06005269 RID: 21097 RVA: 0x002546EC File Offset: 0x002536EC
			...
			if (control <= RtfControlWord.Ctrl_PCA)
			{
				...
				else if (control <= RtfControlWord.Ctrl_HIGHLIGHT)
				{
					if (control <= RtfControlWord.Ctrl_FS)
					{
						...
						{
							if (this._converterState.PreviousTopFormatState(1).RtfDestination != RtfDestination.DestFontTable)
							{
								return;
							}
		...
		// Token: 0x0600526A RID: 21098 RVA: 0x002557F0 File Offset: 0x002547F0
		...
		// Token: 0x0600526B RID: 21099 RVA: 0x00255894 File Offset: 0x00254894
		...
		// Token: 0x0600526C RID: 21100 RVA: 0x00255936 File Offset: 0x00254936
		...
		// Token: 0x0600526D RID: 21101 RVA: 0x00255966 File Offset: 0x00254966
		...
		// Token: 0x0600526E RID: 21102 RVA: 0x00255990 File Offset: 0x00254990
		...
		// Token: 0x0600526F RID: 21103 RVA: 0x00255A27 File Offset: 0x00254A27
		internal void HandlePage(RtfToken token, FormatState formatState)
		{
			this.WrapPendingInlineInParagraph(token, formatState);
		}

		// Token: 0x06005270 RID: 21104 RVA: 0x00255A34 File Offset: 0x00254A34
		...
		// Token: 0x06005271 RID: 21105 RVA: 0x00255AC4 File Offset: 0x00254AC4
		...
		// Token: 0x06005272 RID: 21106 RVA: 0x00255B54 File Offset: 0x00254B54
		...
		// Token: 0x06005273 RID: 21107 RVA: 0x00255BB4 File Offset: 0x00254BB4
			...
			if (control <= RtfControlWord.Ctrl_NESTTABLEPROPS)
			{
				if (control != RtfControlWord.Ctrl_CELL)
				{
					...
					case RtfControlWord.Ctrl_NESTCELL:
					{
						...
						if (documentNodeArray.GetTableScope() != DocumentNodeType.dnCell || num < 2)
						{
							this.HandlePara(token, formatState);
						}
		...
		// Token: 0x06005274 RID: 21108 RVA: 0x00255DC0 File Offset: 0x00254DC0
		...
		// Token: 0x06005275 RID: 21109 RVA: 0x00255E28 File Offset: 0x00254E28
		...
		// Token: 0x06005276 RID: 21110 RVA: 0x00255EC4 File Offset: 0x00254EC4
		internal void HandleListTokens(RtfToken token, FormatState formatState)
		{
			ListTable listTable = this._converterState.ListTable;
			ListOverrideTable listOverrideTable = this._converterState.ListOverrideTable;
			bool flag = this._converterState.PreviousTopFormatState(0) != null;
			FormatState formatState2 = this._converterState.PreviousTopFormatState(1);
			if (!flag || formatState2 == null)
			{
				return;
			}
			RtfControlWord control = token.RtfControlWordInfo.Control;
			if (control <= RtfControlWord.Ctrl_LISTOVERRIDE)
			{
				...
				default:
					...
					case RtfControlWord.Ctrl_LISTLEVEL:
					{
						...
						{
							controllingLevelTable3.AddEntry();
							return;
						}
						return;
					}
					case RtfControlWord.Ctrl_LISTNAME:
						return;
					case RtfControlWord.Ctrl_LISTOVERRIDE:
						if (this._converterState.PreviousTopFormatState(1).RtfDestination == RtfDestination.DestListOverrideTable)
						{
			...
			else
			{
				...
				case RtfControlWord.Ctrl_LISTTEXT:
					if (formatState2.IsContentDestination || formatState.IsHidden)
					{
						formatState.RtfDestination = RtfDestination.DestListText;
						this._converterState.DocumentNodeArray.Push(new DocumentNode(DocumentNodeType.dnListText)
						{
		...
		// Token: 0x06005277 RID: 21111 RVA: 0x00256170 File Offset: 0x00255170
		internal void HandleShapeTokens(RtfToken token, FormatState formatState)
		{
			...
			else if (control != RtfControlWord.Ctrl_NONSHPPICT)
			{
				...
				else
				{
					...
					if (num2 >= 0)
					{
						documentNodeArray.EntryAt(num2).HasMarkerContent = true;
					}
		...
		// Token: 0x06005278 RID: 21112 RVA: 0x002562DC File Offset: 0x002552DC
		...
		// Token: 0x06005279 RID: 21113 RVA: 0x002564A8 File Offset: 0x002554A8
		...
		// Token: 0x0600527A RID: 21114 RVA: 0x00257178 File Offset: 0x00256178
		internal void HandleFieldTokens(RtfToken token, FormatState formatState)
		{
			...
			if (control != RtfControlWord.Ctrl_FIELD)
			{
				...
				case RtfControlWord.Ctrl_FLDINST:
					if (formatState2.RtfDestination != RtfDestination.DestField)
					{
						return;
					}
			...
			this._converterState.DocumentNodeArray.Push(new DocumentNode(DocumentNodeType.dnFieldBegin)
			{
				FormatState = new FormatState(formatState),
				IsPending = false,
				IsTerminated = true
		...
		// Token: 0x0600527B RID: 21115 RVA: 0x00257264 File Offset: 0x00256264
		internal void HandleTableNesting(FormatState formatState)
		{
			...
			else
			{
				...
				if (num4 >= 0)
				{
					...
					if (documentNodeArray.FindPending(DocumentNodeType.dnCell, num5) == -1)
					{
		...
		// Token: 0x0600527C RID: 21116 RVA: 0x0025740C File Offset: 0x0025640C
		internal MarkerList GetMarkerStylesOfParagraph(MarkerList mlHave, FormatState fs, bool bMarkerPresent)
		{
			...
			ListOverride listOverride = this._converterState.ListOverrideTable.FindEntry((int)fs.ILS);
		...
		// Token: 0x0600527D RID: 21117 RVA: 0x00257564 File Offset: 0x00256564
		...
		// Token: 0x0600527E RID: 21118 RVA: 0x00257710 File Offset: 0x00256710
		...
		// Token: 0x0600527F RID: 21119 RVA: 0x002578A8 File Offset: 0x002568A8
		...
		// Token: 0x06005280 RID: 21120 RVA: 0x00257910 File Offset: 0x00256910
		...
		// Token: 0x06005281 RID: 21121 RVA: 0x00257990 File Offset: 0x00256990
		...
		// Token: 0x06005282 RID: 21122 RVA: 0x00257A15 File Offset: 0x00256A15
		internal void ProcessColorTableText(RtfToken token)
		{
			this._converterState.ColorTable.FinishColor();
		}

		// Token: 0x06005283 RID: 21123 RVA: 0x00257A28 File Offset: 0x00256A28
		...
		// Token: 0x06005284 RID: 21124 RVA: 0x00257A68 File Offset: 0x00256A68
		...
		// Token: 0x06005285 RID: 21125 RVA: 0x00257B34 File Offset: 0x00256B34
		...
		// Token: 0x06005286 RID: 21126 RVA: 0x00257BB4 File Offset: 0x00256BB4
		...
		// Token: 0x06005287 RID: 21127 RVA: 0x00257C20 File Offset: 0x00256C20
		...
		// Token: 0x06005288 RID: 21128 RVA: 0x00257CA0 File Offset: 0x00256CA0
		...
		// Token: 0x06005289 RID: 21129 RVA: 0x00257D20 File Offset: 0x00256D20
		...
		// Token: 0x0600528A RID: 21130 RVA: 0x00257D94 File Offset: 0x00256D94
