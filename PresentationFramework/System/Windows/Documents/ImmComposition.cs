...
namespace System.Windows.Documents
{
	...
	{
		// Token: 0x06004DCA RID: 19914 RVA: 0x00240F9A File Offset: 0x0023FF9A
		internal ImmComposition(HwndSource source)
		{
			this.UpdateSource(null, source);
		}

		// Token: 0x06004DCB RID: 19915 RVA: 0x00240FAC File Offset: 0x0023FFAC
		...
		// Token: 0x06004DCC RID: 19916 RVA: 0x00241020 File Offset: 0x00240020
		...
		// Token: 0x06004DCD RID: 19917 RVA: 0x0024107C File Offset: 0x0024007C
		...
		// Token: 0x06004DCE RID: 19918 RVA: 0x00241110 File Offset: 0x00240110
		...
		// Token: 0x06004DCF RID: 19919 RVA: 0x00241150 File Offset: 0x00240150
		...
		// Token: 0x06004DD0 RID: 19920 RVA: 0x00241170 File Offset: 0x00240170
		...
		// Token: 0x06004DD1 RID: 19921 RVA: 0x0024120C File Offset: 0x0024020C
		internal void OnSelectionChange()
		{
			this._compositionModifiedByEventListener = true;
		}

		// Token: 0x06004DD2 RID: 19922 RVA: 0x00241215 File Offset: 0x00240215
		...
		// (get) Token: 0x06004DD3 RID: 19923 RVA: 0x00241226 File Offset: 0x00240226
		...
		// Token: 0x06004DD4 RID: 19924 RVA: 0x00241234 File Offset: 0x00240234
		private void OnSourceChanged(object sender, SourceChangedEventArgs e)
		{
			HwndSource newSource = e.NewSource as HwndSource;
			HwndSource hwndSource = e.OldSource as HwndSource;
		...
		// Token: 0x06004DD5 RID: 19925 RVA: 0x00241288 File Offset: 0x00240288
		...
		// Token: 0x06004DD6 RID: 19926 RVA: 0x00241334 File Offset: 0x00240334
		...
		// Token: 0x06004DD7 RID: 19927 RVA: 0x002413E4 File Offset: 0x002403E4
		...
		// Token: 0x06004DD8 RID: 19928 RVA: 0x002415A4 File Offset: 0x002405A4
		private void OnWmImeChar(IntPtr wParam, ref bool handled)
		{
			...
			try
			{
				...
				else
				{
					...
					this._caretOffset = 1;
					if (this.RaiseTextInputStartEvent(composition, resultLength, text))
					{
						this.CompleteComposition();
					}
					else if (this.RaiseTextInputEvent(composition, text))
					{
						this.CompleteComposition();
						goto IL_A7;
					}
		...
		// Token: 0x06004DD9 RID: 19929 RVA: 0x0024166C File Offset: 0x0024066C
		...
		// Token: 0x06004DDA RID: 19930 RVA: 0x002419BC File Offset: 0x002409BC
		private void UpdateNearCaretCompositionWindow()
		{
			...
			IntPtr handle = ((IWin32Window)this._source).Handle;
		...
		// Token: 0x06004DDB RID: 19931 RVA: 0x00241BF4 File Offset: 0x00240BF4
		private void OnHwndDisposed(object sender, EventArgs args)
		{
			this.UpdateSource(this._source, null);
		}

		// Token: 0x06004DDC RID: 19932 RVA: 0x00241C04 File Offset: 0x00240C04
		private void UpdateCompositionString(char[] resultChars, char[] compositionChars, int caretOffset, int deltaStart, byte[] attributes)
		{
			...
			try
			{
				...
				else
				{
					...
					else if (compositionChars != null && this.RaiseTextInputUpdateEvent(composition, resultLength, text))
					{
						this.CompleteComposition();
						return;
					}
					if (compositionChars == null && this.RaiseTextInputEvent(composition, text))
					{
						this.CompleteComposition();
					}
					else if (this._startComposition != null)
					{
		...
		// Token: 0x06004DDD RID: 19933 RVA: 0x00241CF8 File Offset: 0x00240CF8
		...
		// Token: 0x06004DDE RID: 19934 RVA: 0x00241D65 File Offset: 0x00240D65
		...
		// Token: 0x06004DDF RID: 19935 RVA: 0x00241D9C File Offset: 0x00240D9C
		...
		// Token: 0x06004DE0 RID: 19936 RVA: 0x00241E18 File Offset: 0x00240E18
		...
		// Token: 0x06004DE1 RID: 19937 RVA: 0x00241E7C File Offset: 0x00240E7C
		...
		// Token: 0x06004DE2 RID: 19938 RVA: 0x00241EE4 File Offset: 0x00240EE4
		...
		// Token: 0x06004DE3 RID: 19939 RVA: 0x00241F00 File Offset: 0x00240F00
		...
		// Token: 0x06004DE4 RID: 19940 RVA: 0x00242088 File Offset: 0x00241088
		...
		// Token: 0x06004DE5 RID: 19941 RVA: 0x002421E4 File Offset: 0x002411E4
		...
		// Token: 0x06004DE6 RID: 19942 RVA: 0x00242264 File Offset: 0x00241264
		...
		// Token: 0x06004DE7 RID: 19943 RVA: 0x002422EC File Offset: 0x002412EC
		...
		// Token: 0x06004DE8 RID: 19944 RVA: 0x00242344 File Offset: 0x00241344
		private IntPtr OnWmImeRequest_ReconvertString(IntPtr lParam, ref bool handled, bool fDocFeed)
		{
			...
			if (lParam != IntPtr.Zero)
			{
				...
				Marshal.StructureToPtr<NativeMethods.RECONVERTSTRING>(reconvertstring, lParam, true);
		...
		// Token: 0x06004DE9 RID: 19945 RVA: 0x002424BC File Offset: 0x002414BC
		...
		// Token: 0x06004DEA RID: 19946 RVA: 0x002424FC File Offset: 0x002414FC
		...
		// Token: 0x06004DEB RID: 19947 RVA: 0x00242698 File Offset: 0x00241698
		private IntPtr OnWmImeRequest_ConfirmReconvertString(IntPtr lParam, ref bool handled)
		{
			...
			{
				ITextPointer textPointer = this._editor.Selection.Start.CreatePointer(LogicalDirection.Backward);
		...
		// Token: 0x06004DEC RID: 19948 RVA: 0x00242790 File Offset: 0x00241790
		...
		// Token: 0x06004DED RID: 19949 RVA: 0x002427FC File Offset: 0x002417FC
		...
		// Token: 0x06004DEE RID: 19950 RVA: 0x00242831 File Offset: 0x00241831
		private void OnMouseButtonEvent(object sender, MouseButtonEventArgs e)
		{
			e.Handled = this.InternalMouseEventHandler();
		}

		// Token: 0x06004DEF RID: 19951 RVA: 0x00242831 File Offset: 0x00241831
		private void OnMouseEvent(object sender, MouseEventArgs e)
		{
			e.Handled = this.InternalMouseEventHandler();
		}

		// Token: 0x06004DF0 RID: 19952 RVA: 0x00242840 File Offset: 0x00241840
		private bool InternalMouseEventHandler()
		{
			...
			if (intPtr != IntPtr.Zero)
			{
				...
				value2 = UnsafeNativeMethods.SendMessage(UnsafeNativeMethods.ImmGetDefaultIMEWnd(new HandleRef(this, handle)), ImmComposition.s_MsImeMouseMessage, new IntPtr(value), intPtr);
			}
			return value2 != IntPtr.Zero;
		}

		// Token: 0x06004DF1 RID: 19953 RVA: 0x00242A94 File Offset: 0x00241A94
		private void OpenCompositionUndoUnit()
		{
			UndoManager undoManager = UndoManager.GetUndoManager(this._editor.TextContainer.Parent);
		...
		// Token: 0x06004DF2 RID: 19954 RVA: 0x00242B24 File Offset: 0x00241B24
		...
		// Token: 0x06004DF3 RID: 19955 RVA: 0x00242B88 File Offset: 0x00241B88
		...
		// Token: 0x06004DF4 RID: 19956 RVA: 0x00242BD5 File Offset: 0x00241BD5
		...
		// (get) Token: 0x06004DF5 RID: 19957 RVA: 0x00242BF8 File Offset: 0x00241BF8
		...
		// (get) Token: 0x06004DF6 RID: 19958 RVA: 0x00242C19 File Offset: 0x00241C19
		...
		// (get) Token: 0x06004DF7 RID: 19959 RVA: 0x00242C30 File Offset: 0x00241C30
		...
		// (get) Token: 0x06004DF8 RID: 19960 RVA: 0x00242C56 File Offset: 0x00241C56
