...
[AddComponentMenu("Interactivity/Machine Listeners/Machine Active Instantiate")]
public class MachineActiveInstantiate : MachineActive
{
	...
	private void Start()
	{
		...
		OnMachineActiveInit(InteractiveObject.IsActive);
	}
	...
	private void OnMachineActiveInit(bool active)
	{
		if (active && PrefabInit != null)
		{
			InstantiatePrefab();
		}
	}
