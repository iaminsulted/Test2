...
public class Tooltip_bak2 : MonoBehaviour
{
	protected static Tooltip_bak2 mInstance;
	...
	protected virtual void SetText(string tooltipText, Vector3 position, UIWidget.Pivot alignment)
	{
	...
	public static void ShowText(string tooltipText, UIWidget.Pivot alignment = UIWidget.Pivot.TopLeft)
	{
		if (mInstance != null)
		{
			mInstance.SetText(tooltipText, Input.mousePosition, alignment);
		}
	}

	public static void ShowTextAt(string tooltipText, Vector3 position, UIWidget.Pivot alignment = UIWidget.Pivot.Center)
	{
		if (mInstance != null)
		{
